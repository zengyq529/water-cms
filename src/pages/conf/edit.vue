  ...
  >
    <div style="padding:0px 20px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="mini">
        <el-form-item label="结算日期" prop="log_date">
          <el-input v-model="form.log_date" placeholder></el-input>
        </el-form-item>
        <el-form-item label="GDP" prop="gdp">
          <el-input v-model="form.gdp" placeholder></el-input>
        </el-form-item>
        <el-form-item label="结算日期" prop="log_date">
          <el-input v-model="form.log_date" placeholder></el-input>
        </el-form-item>
        ...
        <el-form-item label="评分" prop="score">
          <el-checkbox v-model="form.score"></el-checkbox>
        </el-form-item>
